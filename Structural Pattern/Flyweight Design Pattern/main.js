...
const greenCircle = circleFactory.getCircle("blued");
greenCircle.draw("medium", 200, 300); // Here it won't create a new object as it already exists with same attributes
